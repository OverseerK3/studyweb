        ...
        <>
            <div className="w-full h-[20vh] bg-[#242423] px-52 py-4 border-b">
                <div className="flex justify-center items-center  ">
                    <p className='text-5xl text-white mr-3'>
                        <Link
                            to="/"
                ...
                <div className="h-11 w-full bg-transparent  mt-4 flex items-center justify-between">
                    <ul className='flex justify-start items-center'>
                        {trending.map((item, index) => (
                            <li key={index} className='text-white  rounded-2xl px-2 py-1 mt-1 hover:bg-black mr-2'><a href="">{item.label}</a> </li>
                        ))}
                    </ul>
                    <ul>
                        <li>
                            <button
                                onClick={openDialog}
                                className='text-white  rounded-2xl px-2 py-1 mt-1 hover:bg-black mr-2'
                            >
                                Upload
                            </button>
                        </li>
            ...
            {isDialogOpen && (
                <div className="fixed z-10 inset-0 overflow-y-auto" >
                    <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                        ...
                        <div className="inline-block align-bottom bg-black border border-black backdrop-blur-xl rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                                        ...
                                        <div className="mt-2">
                                            <form className="max-w-lg mx-auto ">
                                                <div className="filename " >
                                                    <label for="website-admin" className="block mb-2 text-sm font-medium  dark:text-white ">File name</label>
                                                    <div className="flex">
                                                        ...
                                                        <input type="text" id="website-admin" className=" rounded-none rounded-e-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="File name" />
                                                    </div>
                                                </div>


                                                <div className="subjectname my-6">
                                                    <label for="website-admin" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Subject Name</label>
                                                    <div className="flex">
                                                        <span className="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border border-e-0 border-gray-300 rounded-s-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                                                            {/* <img src="/FileEarmarkBreak.svg" alt="" className='p-2'  /> */}
                                                            <svg className="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                                                <path d="M10 0a10 10 0 1 0 10 10A10.011 10.011 0 0 0 10 0Zm0 5a3 3 0 1 1 0 6 3 3 0 0 1 0-6Zm0 13a8.949 8.949 0 0 1-4.951-1.488A3.987 3.987 0 0 1 9 13h2a3.987 3.987 0 0 1 3.951 3.512A8.949 8.949 0 0 1 10 18Z" />
                                                            </svg>
                                                        </span>
                                                ...
                                                <div className="upload-file mb-6">
                            ...
                            <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse flex justify-center">
                                <button onClick={closeDialog} type="button" className="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-[#242423] text-base font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:ml-3 sm:w-auto sm:text-sm">
                                    Upload
                                </button>
                            </div>
                        </div>
