...
function Upload() {
    return (
        <>
            <div className="main-Container flex justify-center items-cente ">
                <div className="upload-main  p-8 border backdrop-blur-sm ">
                    <form className="max-w-lg mx-auto">
                        ...
                        <div className="uplaodbtn flex justify-center font-medium">
                            <button className='text bg-white px-6 py-2 text-center rounded  hover:bg-[#374151] hover:text-white '>Upload</button>
                        </div>
                    </form>
                </div>
            </div>
